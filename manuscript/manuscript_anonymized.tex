...
\textbf{Preregistration:} This study was not preregistered; all analyses are exploratory. \textbf{Materials:} All study materials are publicly available [URL removed for blind review]. \textbf{Data:} All data are publicly available [URL removed for blind review]. The analytical dataset, raw fraud records, and source data are included. \textbf{Analysis scripts:} All analysis scripts are publicly available [URL removed for blind review]. Full replication code is included.
